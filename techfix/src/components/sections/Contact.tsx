...
const Contact = () => {
  ...
  return (
    <section id="contato" className="py-20 bg-gradient-to-b from-byteDarker to-deepPetrolDarker relative overflow-hidden">
      {/* Background Elements */}
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <p className="section-description">
            Estamos aqui para ajudar com todos os seus problemas de computador
          </p>
        </motion.div>
          ...
          >
            ...
            <div className="space-y-6">
              <div className="flex items-start">
                <div className="bg-bit/20 p-3 rounded-lg mr-4">
                  <svg className="w-6 h-6 text-bit" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-white/70">contato@techfix.com.br</p>
                </div>
              </div>
            ...
            <div className="mt-8">
              ...
              <div className="flex space-x-4">
                <motion.a
                  ...
                  className="bg-bit/20 p-3 rounded-lg text-white hover:bg-bit/30 transition-colors"
                >
